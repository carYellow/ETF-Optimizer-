...
class PredictionRequest(BaseModel):
    symbol: str = Field(..., description="Stock symbol/ID (e.g., AAPL, MSFT, GOOG)")
    date: Optional[str] = Field(None, description="Date for prediction in YYYY-MM-DD format. If not provided, the latest available date will be used.")
